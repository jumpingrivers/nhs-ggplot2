...
subtitle: "NHS R Conference 2019"
...
* We'll start when the timer runs out
...
```{r, echo = FALSE}
countdown::countdown(minutes = 4, seconds = 30)  
```
...
*  Many different ways to make graphs in R

* **ggplot2** started in 2005 and follows the "Grammar of Graphics" 

* Many companies have adopted **ggplot2** for graphics, including the [BBC](https://bbc.github.io/rcookbook/)

* Think about graphics in terms of "layers"
...
b + labs(x = "Movie classification", 
         ...
         caption = "These boxplots represent etc etc")
```
...
* Are you plotting something sensible (is your data catergorial?)
...
@jumping_uk @trianglegirl #NHSR #NHSRconf2019
